...
public class opflight extends LaunchBrowser{
	    ...
	    static By Departure=By.xpath("//div[@id='select2-drop']//ul[@class='select2-results']");
	    ...
	    public void FlightPage() throws Exception 
	    {
	        ...
	        driver.findElement(By.xpath("//div[7]//nav[1]//div[3]")).click();
	        driver.findElement(By.xpath("//div[@class='datepicker--cell datepicker--cell-year'][contains(text(),'"+prop.getProperty("year")+"')]")).click();
